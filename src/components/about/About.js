    ...
    return (
        <div>
            ...
            <div class="about-text">
                ...
                <p>We are constantly updating this application so please stay tuned. You are welcome to follow it's progress on the <a href="https://github.com/riderjensen/arcanite-front" target="_blank" rel="noopener noreferrer">Github page</a>.</p>
            </div>
        </div>
    )
}
